  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <div class="container-fluid">
      ...
      <div class="d-flex align-items-center">
        ...
        <button class="btn btn-outline-light btn-sm" id="refreshButton" onclick="restartServer()">
  ...
  <div class="container-fluid mt-3">
    <div class="row">
      ...
      <div class="col-md-4">
        ...
        <div class="card mb-4 d-none" id="photoManagerCard">
          <div class="card-header">
        ...
        <div class="card">
          <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <div class="d-flex align-items-center">
              ...
              <select id="chatNodeSelect" class="form-select form-select-sm" style="width: auto;" disabled>
          ...
          <div class="card-body" style="max-height:300px; overflow-y:auto; background-color: #f8f9fa;" id="chatMessages">
            <div class="text-center text-muted py-4">
              ...
              <p class="mt-2">Broadcast a message to all reachable nodes.</p>
            </div>
          </div>
          <div class="card-footer d-flex">
            <input id="chatInput" class="form-control me-2" placeholder="Message broadcast...">
...
loadNodeInfo();
    ...
    // Chat state defaults to broadcast-only messaging
    let selectedNode = 'broadcast';
    ...
    function updateNodeSelector(nodes) {
      ...
      select.innerHTML = '<option value="broadcast">📡 Broadcast (All Messages)</option>';
      ...
      input.placeholder = 'Message broadcast...';
    }
